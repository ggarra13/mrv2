...
echo "Native compiler ${NATIVE_COMPILER} version ${NATIVE_COMPILER_VERSION}, ${CPU_CORES} cores"
echo "Generic with ${GENERIC_COMPILER} version ${GENERIC_COMPILER_VERSION}, ${CPU_CORES} cores"
...
#
export  VCPKG_ROOT=$PWD/$BUILD_DIR/deps/vcpkg/src/vcpkg
