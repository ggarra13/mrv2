...
LANGUAGE        - Languaje a ser usado en la interfaz (Usualmente seteado por el OS).
OCIO            - Dónde se ubica el archivo config de OpenColorIO.

MRV2_LICENSE_SERVER - Servidor a conectar para obtener una licencia (v)mrv2. 
MRV2_LICENSEPATH    - Carpeta a donde la licencia flotante mrv2_licenses.lic
                      está.
