...
Desde la version v1.3.6, salida de Video y Audio de NDI® fue agregado.  Esto te permite transmitir los contenidos de qué se reproduce en mrv2 a cualquier software o dispositivo de NDI® compatible (como NDI® Tools Studio Monitor en Windows o NDI® Tools Video Monitor en macOS o otras instancias de mrv2 mismo).
