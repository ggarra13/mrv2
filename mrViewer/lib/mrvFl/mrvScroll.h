...
/**
  ...
  The Scroll widget calculates the bounding box of all its children
  ...
  at the relevant corner(s) of the Scroll widget, for instance:
  \code
    Scroll scroll(100, 100, 200, 200); // Scroll at (100, 100)
  ...
  Use Scroll::type() to change this as follows :

  - 0                            - No scrollbars
  - Scroll::HORIZONTAL        - Only a horizontal scrollbar.
  - Scroll::VERTICAL          - Only a vertical scrollbar.
  - Scroll::BOTH              - The default is both scrollbars.
  - Scroll::HORIZONTAL_ALWAYS - Horizontal scrollbar always on, vertical always off.
  - Scroll::VERTICAL_ALWAYS   - Vertical scrollbar always on, horizontal always off.
  - Scroll::BOTH_ALWAYS       - Both always on.
  ...
  fit inside the Scroll without scrolling.  Be sure to leave
...
*/
class FL_EXPORT Scroll : public Fl_Group {
