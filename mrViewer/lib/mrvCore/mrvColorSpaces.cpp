...
namespace {
   ...
   */
  inline
  float hue( const Color4f& rgb, const float maxV, const float spanV )
  {
    float h;
    if ( rgb.r == maxV ) {
      h = (rgb.g - rgb.b) / spanV;
...
namespace mrv {
  ...
  namespace color {
    ...
    namespace rgb {
      ...
      Color4f to_hsv( const Color4f& rgb )
      {
      ...
      Color4f to_hsl( const Color4f& rgb )
      {
        float minV  = std::min( rgb.r, std::min( rgb.g, rgb.b ) );
        float maxV  = std::max( rgb.r, std::max( rgb.g, rgb.b ) );
        float spanV = maxV - minV;
      ...
      // Analog NTSC
      Color4f to_yiq( const Color4f& rgb )
      {
        return Color4f(
      ...
      // Analog PAL
      Color4f to_yuv( const Color4f& rgb )
      {
        return Color4f(
                           rgb.r * 0.299f   + rgb.g * 0.587f   + rgb.b * 0.114f,
      ...
      // Analog Secam/PAL-N
      Color4f to_YDbDr( const Color4f& rgb )
      {
        return Color4f(
                           rgb.r * 0.299f + rgb.g * 0.587f + rgb.b * 0.114f,
      ...
      Color4f to_ITU601( const Color4f& rgb )
      {
        return Color4f(
      ...
      Color4f to_ITU709( const Color4f& rgb )
      {
        return Color4f(
                           rgb.r * 0.299f + rgb.g * 0.587f + rgb.b * 0.114f,
  ...
  namespace yuv {
      ...
      // Analog PAL
      Color4f to_rgb( const Color4f& yuv )
      {
