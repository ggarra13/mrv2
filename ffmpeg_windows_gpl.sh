...
#
# This script compiles a GPL version of ffmpeg
#
...
mkdir -p x265
cd x265
CC=cl ./../../sources/x265/configure --prefix=./../../installed --enable-shared
make -j ${CPU_CORES}
make install
mv ./../../installed/lib/libx265.dll.lib ./../../installed/lib/libx265.lib
