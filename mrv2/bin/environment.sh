...
export PYTHONPATH="${dir}/../../..:${dir}/lib/python310.zip:${dir}/lib/python3.10:${dir}/lib/python3.10:${dir}/lib/python3.10/lib-dynload:${dir}/lib/python3.10/site-packages:${PYTHONPATH}"
