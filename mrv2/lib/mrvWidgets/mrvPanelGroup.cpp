...
// WITH x, y co-ordinates
    PanelGroup::PanelGroup(DockGroup *dk, int floater, int x, int y, int w,
...
// construction function
    ...
    void PanelGroup::create_floating(DockGroup *dk, int full, int x, int y, int w, int h, const char *lbl)
    {
        // create the group itself
        create_dockable_group(lbl);
