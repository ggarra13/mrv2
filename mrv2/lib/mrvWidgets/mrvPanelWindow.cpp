...
// HACK:: This just stores the PanelWindowdows in a static array. I'm too lazy
//        to make a proper linked list to store these in...
    PanelWindow* PanelWindow::active_list[TW_MAX_FLOATERS]; // list of active PanelWindows
