...
namespace mrv
{
    ...
    OpenSeparateAudioDialog::OpenSeparateAudioDialog(
        const std::shared_ptr<system::Context>& context, ViewerUI* ui) :
    ...
    void
    OpenSeparateAudioDialog::_browseVideoCallback_cb(Fl_Widget* w, void* data)
    {
        OpenSeparateAudioDialog* self =
            static_cast<OpenSeparateAudioDialog*>(data);
        self->_browseVideoCallback(w, data);
    }

    void
    OpenSeparateAudioDialog::_browseAudioCallback_cb(Fl_Widget* w, void* data)
    {
        OpenSeparateAudioDialog* self =
            static_cast<OpenSeparateAudioDialog*>(data);
