...
void timeToText(char *out, const otime::RationalTime &time,
...
otime::RationalTime textToTime(const String &text, double rate, TimeUnits units,
                               otime::ErrorStatus *errorStatus) {
  ...
  case TimeUnits::Seconds:
    ...
    break;
  case TimeUnits::Timecode:
    out = otime::RationalTime::from_timecode(text.c_str(), rate, errorStatus);
    break;
  default:
    break;
  }
...
TimeObject::TimeObject(ViewerUI *m) : ui(m) {}
