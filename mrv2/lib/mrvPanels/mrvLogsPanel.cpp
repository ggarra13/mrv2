...
LogsPanel::LogsPanel(ViewerUI *ui) : _r(new Private), PanelWidget(ui) {
  add_group("Logs");
...
void LogsPanel::add_controls() {
  ...
  _r->listWidget =
      new LogDisplay(g->x(), g->y() + 20, g->w(), p.ui->uiViewGroup->h() - 50);

  _r->clearButton = new Fl_Button(g->x(), g->y() + _r->listWidget->h(), 30, 30);
