...
EnvironmentMapPanel::EnvironmentMapPanel(ViewerUI *ui) : PanelWidget(ui) {
  auto view = ui->uiView;
...
void EnvironmentMapPanel::add_controls() {
  ...
  auto rB =
      new Widget<Fl_Radio_Round_Button>(g->x(), 90, g->w(), 20, _("None"));
  r = rB;
  r->labelsize(12);
  ...
  rB =
      new Widget<Fl_Radio_Round_Button>(g->x(), 90, g->w(), 20, _("Spherical"));
  r = rB;
  r->labelsize(12);
  ...
  rB = new Widget<Fl_Radio_Round_Button>(g->x(), 90, g->w(), 20, _("Cubic"));
  r = rB;
  r->labelsize(12);
  ...
  auto sV = new Widget<HorSlider>(g->x(), 90, g->w(), 20, _("H. Aperture"));
  s = sV;
  ...
  s = focalLength = sV;
  s->tooltip(_("Focal Length of the Projection. Use Shift + left mouse button"
  ...
  auto cB = new Widget<Fl_Check_Button>(g->x(), 90, g->w(), 20, _("Spin"));
  c = cB;
  c->labelsize(12);
  ...
  s = rotateX = sV;
  s->tooltip(_("Rotation in X of the projection.  Use middle mouse button to "
               "move around."));
  s->range(-90.f, 90.0f);
  ...
  s = rotateY = sV;
  s->tooltip(_("Rotation in Y of the projection.  Use middle mouse button to "
               "move around."));
