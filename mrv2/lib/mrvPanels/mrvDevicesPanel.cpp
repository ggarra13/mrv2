...
namespace mrv
{
    ...
    void DevicesPanel::add_controls()
    {
        ...
        dW->callback( [=] ( auto o )
            {
                auto hdrData = _p->ui->app->devicesModel()->observeData()->get().hdrData;
                hdrData.displayMasteringLuminance =
            ...
            [this](const DevicesModelData& value)
                {
                    ...
                    }
                    {
                        ...
                        _r->redPrimariesSpinBoxes.first->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->redPrimariesSpinBoxes.second->value(value.hdrData.redPrimaries.y);
                        _r->redPrimariesSpinBoxes.second->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->greenPrimariesSpinBoxes.first->value(value.hdrData.greenPrimaries.x);
                        _r->greenPrimariesSpinBoxes.first->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->greenPrimariesSpinBoxes.second->value(value.hdrData.greenPrimaries.y);
                        _r->greenPrimariesSpinBoxes.second->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->bluePrimariesSpinBoxes.first->value(value.hdrData.bluePrimaries.x);
                        _r->bluePrimariesSpinBoxes.first->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->bluePrimariesSpinBoxes.second->value(value.hdrData.bluePrimaries.y);
                        _r->bluePrimariesSpinBoxes.second->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->whitePrimariesSpinBoxes.first->value(value.hdrData.whitePrimaries.x);
                        _r->whitePrimariesSpinBoxes.first->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->whitePrimariesSpinBoxes.second->value(value.hdrData.whitePrimaries.y);
                        _r->whitePrimariesSpinBoxes.second->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->masteringLuminanceSpinBoxes.first->value(value.hdrData.displayMasteringLuminance.getMin());
                        _r->masteringLuminanceSpinBoxes.first->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->masteringLuminanceSpinBoxes.second->value(value.hdrData.displayMasteringLuminance.getMax());
                        _r->masteringLuminanceSpinBoxes.second->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->maxCLLSlider->value(value.hdrData.maxCLL);
                        _r->maxCLLSlider->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                    {
                        _r->maxFALLSlider->value(value.hdrData.maxFALL);
                        _r->maxFALLSlider->setEnabled(device::HDRMode::Custom == value.hdrMode);
                    }
                });
    }
