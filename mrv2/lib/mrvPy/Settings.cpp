...
namespace mrv
{
    namespace settings
    {
        ...
        {
            auto settings = settingsObject();
            settings->setValue("Performance/TimerMode",
        ...
        {
            auto settings = settingsObject();
            settings->setValue("Performance/AudioBufferFrameCount",
                               static_cast<int>(value));
            if ( settingsPanel ) settingsPanel->refresh();
        }
        ...
        {
            auto settings = settingsObject();
            settings->setValue("Performance/FFmpegYUVToRGBConversion",
                               (int)value);
            if ( settingsPanel ) settingsPanel->refresh();
        }
...
Contains all settings functions.
    ...
    sequence.def("audio", &mrv::settings::fileSequenceAudio,
    ...
    sequence.def("audioFileName",
                 &mrv::settings::fileSequenceAudioFileName,
    ...
    sequence.def("audioDirectory",
                 &mrv::settings::fileSequenceAudioDirectory,
    ...
    misc.def("maxFileSequenceDigits",
                 &mrv::settings::maxFileSequenceDigits,
                 _("Get maximum file sequence digits."));
    
    py::module performance = settings.def_submodule("performance");
    
    performance.def("setTimerMode", &mrv::settings::setTimerMode,
                 _("Set Timer Mode."));
    
    performance.def("timerMode", &mrv::settings::timerMode,
                 _("Get Timer Mode."));
    ...
    performance.def("audioBufferFrameCount",
                 &mrv::settings::audioBufferFrameCount,
    ...
    performance.def("videoRequests",
                 &mrv::settings::videoRequests,
    ...
    performance.def("audioRequests",
                 &mrv::settings::audioRequests,
    ...
    performance.def("sequenceThreadCount",
                 &mrv::settings::sequenceThreadCount,
    ...
    performance.def("FFmpegYUVToRGBConversion",
                 &mrv::settings::FFmpegYUVToRGBConversion,
    ...
    performance.def("FFmpegThreadCount",
                 &mrv::settings::FFmpegThreadCount,
