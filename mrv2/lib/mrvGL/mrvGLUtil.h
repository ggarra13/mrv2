...
inline void drawRectOutline(const std::shared_ptr<timeline::IRender> &render,
                            const math::BBox2i &rect,
...
inline void drawLines(const std::shared_ptr<timeline::IRender> &render,
                      const tl::draw::PointList &pts,
                      const imaging::Color4f &color, const int width,
                      const math::Matrix4x4f &mvp,
...
inline void drawCursor(const std::shared_ptr<timeline::IRender> &render,
                       const math::Vector2i &center, const float perimeter,
                       const float width, const imaging::Color4f &color,
                       const math::Matrix4x4f &mvp) {
  ...
  for (int i = 0; i < triangleAmount; ++i) {
    tl::draw::Point pt(center.x + (radius * cos(i * twoPi / triangleAmount)),
