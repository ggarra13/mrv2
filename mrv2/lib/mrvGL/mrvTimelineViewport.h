...
public:
  ...
  void setColorConfigOptions(const timeline::ColorConfigOptions &) noexcept;
  ...
  void setImageOptions(const std::vector<timeline::ImageOptions> &) noexcept;
  ...
  void
  setDisplayOptions(const std::vector<timeline::DisplayOptions> &) noexcept;
  ...
  void toggleDisplayChannel(const timeline::Channels &, int idx = -1) noexcept;
...
protected:
  ...
  void _updateDisplayOptions(int idx,
                             const timeline::DisplayOptions &d) noexcept;
  void _updateImageOptions(int idx, const timeline::ImageOptions &d) noexcept;
