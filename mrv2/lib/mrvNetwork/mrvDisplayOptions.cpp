...
namespace tl
{
    namespace timeline
    {
        ...
        void to_json(nlohmann::json& j, const DisplayOptions& value)
        {
            ...
            j["mirror"] = mirror;
            j["colorEnabled"] = value.colorEnabled;
            j["color"] = color;
            j["levelsEnabled"] = value.levelsEnabled;
            j["levels"] = levels;
            j["softClipEnabled"] = value.softClipEnabled;
            j["softClip"] = value.softClip;
        ...
        void from_json(const nlohmann::json& j, DisplayOptions& value)
        {
            ...
            j.at("colorEnabled").get_to(value.colorEnabled);
            j.at("color").get_to(value.color);
            j.at("levelsEnabled").get_to(value.levelsEnabled);
            j.at("levels").get_to(value.levels);
            j.at("softClipEnabled").get_to(value.softClipEnabled);
