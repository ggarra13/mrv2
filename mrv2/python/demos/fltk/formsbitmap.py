#
# "$Id: formsbitmap.py 28 2003-07-16 20:00:27Z andreasheld $"
#
# Forms bitmap test program for pyFLTK the Python bindings
...
# bitmap via 'set'
bm1 = Fl_FormsBitmap( FL_BORDER_BOX, 100,160,
	sorceress_width,sorceress_height,"via 'set'")
bm1.set(sorceress_width, sorceress_height,sorceress_bits)  

# bitmap via 'bitmap'
fl_bitmap = Fl_Bitmap(sorceress_bits, sorceress_width, sorceress_height)
bm2 = Fl_FormsBitmap( FL_BORDER_BOX, 225,160,
	sorceress_width,sorceress_height,"via 'Fl_FormsBitmap'")
bm2.bitmap(fl_bitmap.this)
