...
set( CPACK_PACKAGE_FILE_NAME ${CPACK_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}-${CMAKE_SYSTEM_NAME}-${MRV2_ARCHITECTURE} )
...
elseif(UNIX)
	...
	"${CPACK_DEBIAN_PACKAGE_NAME}-${mrv2_VERSION}-${CMAKE_SYSTEM_NAME}-${MRV2_ARCHITECTURE}.deb" )
