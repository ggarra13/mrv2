...
if(APPLE)
    ...
    set(Python_C_FLAGS "-isysroot ${_sdk_LOC} -include Security/Security.h ${CMAKE_C_FLAGS}" )
    set(Python_CXX_COMPILER ${NATIVE_CXX_COMPILER})
    set(Python_CXX_FLAGS "-isysroot ${_sdk_LOC} -include Security/Security.h ${CMAKE_CXX_FLAGS}" )
