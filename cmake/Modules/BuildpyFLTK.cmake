...
elseif(APPLE)
    set(pyFLTK_ENV ${pyFLTK_ENV} "PATH=${pyFLTK_PATH}" "DYLD_LIBRARY_PATH=${CMAKE_INSTALL_PREFIX}/lib" -- )
else()
    set(pyFLTK_ENV ${pyFLTK_ENV} "PATH=${pyFLTK_PATH}" "LD_LIBRARY_PATH=${CMAKE_E_INSTALL_PREFIX}/lib" -- )
endif()
