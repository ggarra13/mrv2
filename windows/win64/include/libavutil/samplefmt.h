...
char* av_get_sample_fmt_string(
    char* buf, int buf_size, enum AVSampleFormat sample_fmt);
...
int av_samples_fill_arrays(
    uint8_t** audio_data, int* linesize, const uint8_t* buf, int nb_channels,
 ...
 */
int av_samples_copy(
    uint8_t** dst, uint8_t* const* src, int dst_offset, int src_offset,
...
int av_samples_set_silence(
    uint8_t** audio_data, int offset, int nb_samples, int nb_channels,
