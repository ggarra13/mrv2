...
typedef struct AVClass
{
     ...
     * class. available since version (51 << 16 | 56 << 8 | 100)
     */
     ...
     */
    int (*query_ranges)(
        struct AVOptionRanges**, void* obj, const char* key, int flags);
 ...
 */
void av_log_once(
    void* avcl, int initial_level, int subsequent_level, int* state,
    const char* fmt, ...) av_printf_format(5, 6);
...
void av_log_format_line(
    void* ptr, int level, const char* fmt, va_list vl, char* line,
    int line_size, int* print_prefix);
