...
int av_image_fill_linesizes(
    int linesizes[4], enum AVPixelFormat pix_fmt, int width);
...
int av_image_fill_plane_sizes(
    size_t size[4], enum AVPixelFormat pix_fmt, int height,
...
int av_image_fill_pointers(
    uint8_t* data[4], enum AVPixelFormat pix_fmt, int height, uint8_t* ptr,
 ...
 */
int av_image_alloc(
    uint8_t* pointers[4], int linesizes[4], int w, int h,
...
void av_image_copy_plane(
    uint8_t* dst, int dst_linesize, const uint8_t* src, int src_linesize,
...
void av_image_copy_plane_uc_from(
    uint8_t* dst, ptrdiff_t dst_linesize, const uint8_t* src,
    ptrdiff_t src_linesize, ptrdiff_t bytewidth, int height);
 ...
 */
void av_image_copy(
    uint8_t* dst_data[4], int dst_linesizes[4], const uint8_t* src_data[4],
    const int src_linesizes[4], enum AVPixelFormat pix_fmt, int width,
    int height);
...
int av_image_copy_to_buffer(
    uint8_t* dst, int dst_size, const uint8_t* const src_data[4],
    const int src_linesize[4], enum AVPixelFormat pix_fmt, int width,
...
int av_image_check_size(
    unsigned int w, unsigned int h, int log_offset, void* log_ctx);
...
int av_image_check_size2(
    unsigned int w, unsigned int h, int64_t max_pixels,
...
int av_image_fill_black(
    uint8_t* dst_data[4], const ptrdiff_t dst_linesize[4],
    enum AVPixelFormat pix_fmt, enum AVColorRange range, int width, int height);
