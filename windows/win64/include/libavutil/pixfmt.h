...
enum AVPixelFormat {
    AV_PIX_FMT_NONE = -1,
    AV_PIX_FMT_YUV420P, ///< planar YUV 4:2:0, 12bpp, (1 Cr & Cb sample per 2x2
                        ///< Y samples)
    ...
    AV_PIX_FMT_YUV422P, ///< planar YUV 4:2:2, 16bpp, (1 Cr & Cb sample per 2x1
                        ///< Y samples)
    AV_PIX_FMT_YUV444P, ///< planar YUV 4:4:4, 24bpp, (1 Cr & Cb sample per 1x1
                        ///< Y samples)
    AV_PIX_FMT_YUV410P, ///< planar YUV 4:1:0,  9bpp, (1 Cr & Cb sample per 4x4
                        ///< Y samples)
    AV_PIX_FMT_YUV411P, ///< planar YUV 4:1:1, 12bpp, (1 Cr & Cb sample per 4x1
                        ///< Y samples)
    ...
    AV_PIX_FMT_BGR4, ///< packed RGB 1:2:1 bitstream,  4bpp, (msb)1B 2G 1R(lsb),
                     ///< a byte contains two pixels, the first pixel in the
    ...
    AV_PIX_FMT_YUVJ440P, ///< planar YUV 4:4:0 full scale (JPEG), deprecated in
                         ///< favor of AV_PIX_FMT_YUV440P and setting
                         ///< color_range
     ...
     * each bit depth. Notice that each 9/10 bits sample is stored in 16 bits
     * with extra padding. If you want to support multiple bit depths, then
     * using AV_PIX_FMT_YUV420P16* with the bpp stored separately is better.
     */
    ...
    AV_PIX_FMT_YUVA422P, ///< planar YUV 4:2:2 24bpp, (1 Cr & Cb sample per 2x1
                         ///< Y & A samples)
    AV_PIX_FMT_YUVA444P, ///< planar YUV 4:4:4 32bpp, (1 Cr & Cb sample per 1x1
                         ///< Y & A samples)
    ...
    AV_PIX_FMT_XYZ12LE, ///< packed XYZ 4:4:4, 36 bpp, (msb) 12X, 12Y, 12Z
                        ///< (lsb), the 2-byte value for each X/Y/Z is stored as
                        ///< little-endian, the 4 lower bits are set to 0
    AV_PIX_FMT_XYZ12BE, ///< packed XYZ 4:4:4, 36 bpp, (msb) 12X, 12Y, 12Z
                        ///< (lsb), the 2-byte value for each X/Y/Z is stored as
    ...
    AV_PIX_FMT_RGBA64BE, ///< packed RGBA 16:16:16:16, 64bpp, 16R, 16G, 16B,
                         ///< 16A, the 2-byte value for each R/G/B/A component
    ...
    AV_PIX_FMT_YUV440P12BE, ///< planar YUV 4:4:0,24bpp, (1 Cr & Cb sample per
                            ///< 1x2 Y samples), big-endian
    AV_PIX_FMT_AYUV64LE, ///< packed AYUV 4:4:4,64bpp (1 Cr & Cb sample per 1x1
                         ///< Y & A samples), little-endian
    AV_PIX_FMT_AYUV64BE, ///< packed AYUV 4:4:4,64bpp (1 Cr & Cb sample per 1x1
    ...
    AV_PIX_FMT_P210BE, ///< interleaved chroma YUV 4:2:2, 20bpp, data in the
                       ///< high bits, big-endian
    AV_PIX_FMT_P210LE, ///< interleaved chroma YUV 4:2:2, 20bpp, data in the
                       ///< high bits, little-endian

    AV_PIX_FMT_P410BE, ///< interleaved chroma YUV 4:4:4, 30bpp, data in the
                       ///< high bits, big-endian
    AV_PIX_FMT_P410LE, ///< interleaved chroma YUV 4:4:4, 30bpp, data in the
                       ///< high bits, little-endian
    ...
    AV_PIX_FMT_P012LE, ///< like NV12, with 12bpp per component, data in the
                       ///< high bits, zeros in the low bits, little-endian
    AV_PIX_FMT_P012BE, ///< like NV12, with 12bpp per component, data in the
                       ///< high bits, zeros in the low bits, big-endian
    ...
    AV_PIX_FMT_XV30LE, ///< packed XVYU 4:4:4, 32bpp, (msb)2X 10V 10Y 10U(lsb),
                       ///< little-endian, variant of Y410 where alpha channel
                       ///< is left undefined
    ...
    AV_PIX_FMT_XV36LE, ///< packed XVYU 4:4:4, 48bpp, data in the high bits,
                       ///< zeros in the low bits, little-endian, variant of
                       ///< Y412 where alpha channel is left undefined
...
enum AVColorPrimaries {
    ...
    AVCOL_PRI_SMPTE240M = 7, ///< identical to above, also called "SMPTE C" even
                             ///< though it uses D65
...
enum AVColorTransferCharacteristic {
    ...
    AVCOL_TRC_LOG_SQRT = 10, ///< "Logarithmic transfer characteristic (100 *
                             ///< Sqrt(10) : 1 range)"
...
enum AVColorSpace {
    ...
    AVCOL_SPC_RESERVED = 3, ///< reserved for future use by ITU-T and ISO/IEC
                            ///< just like 15-255 are
    AVCOL_SPC_FCC =
