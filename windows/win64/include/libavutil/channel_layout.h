...
#define AV_CH_LAYOUT_22POINT2                                                  \
    (AV_CH_LAYOUT_5POINT1_BACK | AV_CH_FRONT_LEFT_OF_CENTER |                  \
     ...
     AV_CH_TOP_SIDE_RIGHT | AV_CH_TOP_BACK_CENTER |                            \
     AV_CH_BOTTOM_FRONT_CENTER | AV_CH_BOTTOM_FRONT_LEFT |                     \
 ...
 */
attribute_deprecated void av_get_channel_layout_string(
    char* buf, int buf_size, int nb_channels, uint64_t channel_layout);

/**
 * Append a description of a channel layout to a bprint buffer.
 * @deprecated use av_channel_layout_describe()
 */
attribute_deprecated void av_bprint_channel_layout(
    struct AVBPrint* bp, int nb_channels, uint64_t channel_layout);
...
av_get_channel_layout_nb_channels(uint64_t channel_layout);
 ...
 */
attribute_deprecated int
av_get_channel_layout_channel_index(uint64_t channel_layout, uint64_t channel);
 ...
 */
attribute_deprecated int av_get_standard_channel_layout(
    unsigned index, uint64_t* layout, const char** name);
/**
 * @}
 */
#endif
...
void av_channel_description_bprint(
    struct AVBPrint* bp, enum AVChannel channel_id);
...
int av_channel_layout_from_string(
    AVChannelLayout* channel_layout, const char* str);
...
int av_channel_layout_describe(
    const AVChannelLayout* channel_layout, char* buf, size_t buf_size);
...
int av_channel_layout_describe_bprint(
    const AVChannelLayout* channel_layout, struct AVBPrint* bp);
...
int av_channel_layout_index_from_channel(
    const AVChannelLayout* channel_layout, enum AVChannel channel);
 ...
 */
uint64_t
av_channel_layout_subset(const AVChannelLayout* channel_layout, uint64_t mask);
...
int av_channel_layout_compare(
    const AVChannelLayout* chl, const AVChannelLayout* chl1);
