 ...
 */
int av_parse_ratio(
    AVRational* q, const char* str, int max, int log_offset, void* log_ctx);
 ...
 */
int av_parse_color(
    uint8_t* rgba_color, const char* color_string, int slen, void* log_ctx);
...
int av_find_info_tag(
    char* arg, int arg_size, const char* tag1, const char* info);
