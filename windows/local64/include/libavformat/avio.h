...
typedef struct AVIODirEntry
{
    ...
    int64_t
        modification_timestamp; /**< Time of last modification in microseconds
                                   since unix epoch, -1 if unknown. */
    int64_t access_timestamp;   /**< Time of last access in microseconds since
                                   unix epoch,   -1 if unknown. */
    int64_t
...
enum AVIODataMarkerType {
     ...
     * Typically means the end of a packet.
     */
...
typedef struct AVIOContext
{
    ...
    unsigned char*
        buf_end;  /**< End of the data, may be less than
     ...
     */
    int64_t (*read_seek)(
        void* opaque, int stream_index, int64_t timestamp, int flags);
    /**
     ...
     */
    int (*write_data_type)(
        void* opaque, uint8_t* buf, int buf_size, enum AVIODataMarkerType type,
        int64_t time);
    /**
     * If set, don't call write_data_type separately for
     * AVIO_DATA_MARKER_BOUNDARY_POINT, but ignore them and treat them as
     * AVIO_DATA_MARKER_UNKNOWN (to avoid needlessly small chunks of data
...
void avio_write_marker(
    AVIOContext* s, int64_t time, enum AVIODataMarkerType type);
 ...
 */
int avio_open2(
    AVIOContext** s, const char* url, int flags, const AVIOInterruptCB* int_cb,
 ...
 */
int64_t
avio_seek_time(AVIOContext* h, int stream_index, int64_t timestamp, int flags);
