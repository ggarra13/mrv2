...
- Fixed Vulkan macOS installs, besides running it from the shell.  Now you can actually click on the icon (after you authorize the permissions to the application).
