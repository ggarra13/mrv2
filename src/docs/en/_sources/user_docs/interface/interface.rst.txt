...
.. topic:: Eliminación de bandas (solo Vulkan)

Con esta opción, se pueden suavizar áreas de la imagen donde hay gradientes mediante la aplicación de un filtro de desenfoque localizado. Es útil principalmente para archivos de video que son propensos al efecto de bandas. Sin embargo, para trabajos profesionales de video al revisar imágenes, probablemente debería desactivarse.
...
.. topic:: Transitions
   ...
   (Currently not implemented in v1.5.4).
