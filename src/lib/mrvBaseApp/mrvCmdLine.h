...
namespace mrv
{
    namespace app
    {
        ...
        public:
            ...
            //! Is a title project.
            virtual bool isTitle() const { return false; }
        ...
        class CmdLineHeader : public ICmdLineOption
        {
        protected:
            CmdLineHeader(
        ...
        public:
            ...
            static std::shared_ptr<CmdLineHeader> create(
                const std::vector<std::string>& names,
                const std::string& help);
            ...
            virtual bool isTitle() const override { return true; }            
        };
...
#include "mrvBaseApp/mrvCmdLineInline.h"
