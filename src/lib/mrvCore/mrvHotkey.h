...
namespace mrv
{
    ...
    extern Hotkey kEditInsertVideoGap;
    ...
    extern Hotkey kEditFill;
    extern Hotkey kEditMove;
    extern Hotkey kEditTrim;
    extern Hotkey kEditRipple;
    extern Hotkey kEditRoll;
