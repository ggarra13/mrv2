...
int av_fifo_write_from_cb(
    AVFifo* f, AVFifoCB read_cb, void* opaque, size_t* nb_elems);
...
int av_fifo_read_to_cb(
    AVFifo* f, AVFifoCB write_cb, void* opaque, size_t* nb_elems);
 ...
 * @deprecated use av_fifo_alloc2()
 */
attribute_deprecated AVFifoBuffer*
av_fifo_alloc_array(size_t nmemb, size_t size);
...
/**
 * Reset the AVFifoBuffer to the state right after av_fifo_alloc, in particular
 * it is emptied.
 ...
 * callback. Similar as av_fifo_gereric_read but without discarding data.
 * @param f AVFifoBuffer to read from
 ...
 */
attribute_deprecated int av_fifo_generic_peek_at(
    AVFifoBuffer* f, void* dest, int offset, int buf_size,
 ...
 *             av_fifo_peek_to_cb() otherwise
 */
attribute_deprecated int av_fifo_generic_peek(
    AVFifoBuffer* f, void* dest, int buf_size, void (*func)(void*, void*, int));
 ...
 */
attribute_deprecated int av_fifo_generic_read(
    AVFifoBuffer* f, void* dest, int buf_size, void (*func)(void*, void*, int));
 ...
 * @return the number of bytes written to the FIFO or a negative error code on
 * failure
 *
 * @deprecated use the new AVFifo-API with av_fifo_write() when func == NULL,
 *             av_fifo_write_from_cb() otherwise
 */
attribute_deprecated int av_fifo_generic_write(
 ...
 *
 * @deprecated use the new AVFifo-API with av_fifo_grow2() to increase FIFO
 * size, decreasing FIFO size is not supported
 */
 ...
 *
 * @param f AVFifoBuffer to resize
 * @param additional_space the amount of space in bytes to allocate in addition
 * to av_fifo_size()
 * @return <0 for failure, >=0 otherwise
 *
...
av_fifo_grow(AVFifoBuffer* f, unsigned int additional_space);
 ...
 * @deprecated use the new AVFifo-API with av_fifo_peek() or
 * av_fifo_peek_to_cb()
 */
attribute_deprecated static inline uint8_t*
av_fifo_peek2(const AVFifoBuffer* f, int offs)
{
