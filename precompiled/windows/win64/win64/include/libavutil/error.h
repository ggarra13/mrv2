...
#define AVERROR_OUTPUT_CHANGED                                                 \
    (-0x636e6702) ///< Output changed between calls. Reconfiguration is
                  ///< required. (can be OR-ed with AVERROR_INPUT_CHANGED)
/* HTTP & RTSP errors */
...
#define av_err2str(errnum)                                                     \
    av_make_error_string(                                                      \
        (char[AV_ERROR_MAX_STRING_SIZE]){0}, AV_ERROR_MAX_STRING_SIZE, errnum)
