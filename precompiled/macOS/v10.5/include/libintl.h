...
#    define _INTL_ASM(cname)                                                   \
        __asm__(_INTL_ASMNAME(__USER_LABEL_PREFIX__, #cname))
#    define _INTL_ASMNAME(prefix, cnamestring)                                 \
        _INTL_STRINGIFY(prefix) cnamestring
...
/* Look up MSGID in the current default message catalog for the current
   ...
   text).  */
    ...
    static inline _INTL_MAY_RETURN_STRING_ARG(1) char* gettext(
        const char* __msgid)
    {
...
/* Look up MSGID in the DOMAINNAME message catalog for the current
   LC_MESSAGES locale.  */
    ...
    static inline _INTL_MAY_RETURN_STRING_ARG(2) char* dgettext(
        const char* __domainname, const char* __msgid)
    {
...
/* Look up MSGID in the DOMAINNAME message catalog for the current CATEGORY
   locale.  */
    ...
    extern char* libintl_dcgettext(
        ...
        _INTL_MAY_RETURN_STRING_ARG(2);
    static inline _INTL_MAY_RETURN_STRING_ARG(2) char* dcgettext(
        const char* __domainname, const char* __msgid, int __category)
    {
...
/* Similar to 'gettext' but select the plural form corresponding to the
   number N.  */
#ifdef _INTL_REDIRECT_INLINE
    extern char* libintl_ngettext(
        const char* __msgid1, const char* __msgid2, unsigned long int __n)
        _INTL_MAY_RETURN_STRING_ARG(1) _INTL_MAY_RETURN_STRING_ARG(2);
    static inline _INTL_MAY_RETURN_STRING_ARG(1)
        _INTL_MAY_RETURN_STRING_ARG(2) char* ngettext(
            const char* __msgid1, const char* __msgid2, unsigned long int __n)
    {
...
ngettext(const char* __msgid1, const char* __msgid2, unsigned long int __n)
    _INTL_ASM(libintl_ngettext) _INTL_MAY_RETURN_STRING_ARG(1)
        _INTL_MAY_RETURN_STRING_ARG(2);
#endif
...
/* Similar to 'dgettext' but select the plural form corresponding to the
   number N.  */
#ifdef _INTL_REDIRECT_INLINE
    extern char* libintl_dngettext(
        const char* __domainname, const char* __msgid1, const char* __msgid2,
        unsigned long int __n) _INTL_MAY_RETURN_STRING_ARG(2)
        _INTL_MAY_RETURN_STRING_ARG(3);
    static inline _INTL_MAY_RETURN_STRING_ARG(2)
        _INTL_MAY_RETURN_STRING_ARG(3) char* dngettext(
            const char* __domainname, const char* __msgid1,
...
/* Similar to 'dcgettext' but select the plural form corresponding to the
   number N.  */
#ifdef _INTL_REDIRECT_INLINE
    extern char* libintl_dcngettext(
        const char* __domainname, const char* __msgid1, const char* __msgid2,
        unsigned long int __n, int __category) _INTL_MAY_RETURN_STRING_ARG(2)
        _INTL_MAY_RETURN_STRING_ARG(3);
    static inline _INTL_MAY_RETURN_STRING_ARG(2)
        _INTL_MAY_RETURN_STRING_ARG(3) char* dcngettext(
            const char* __domainname, const char* __msgid1,
            const char* __msgid2, unsigned long int __n, int __category)
    {
        return libintl_dcngettext(
...
extern char* dcngettext(
    const char* __domainname, const char* __msgid1, const char* __msgid2,
    unsigned long int __n, int __category) _INTL_ASM(libintl_dcngettext)
    _INTL_MAY_RETURN_STRING_ARG(2) _INTL_MAY_RETURN_STRING_ARG(3);
#endif
...
#ifdef _INTL_REDIRECT_INLINE
    extern char*
    libintl_bindtextdomain(const char* __domainname, const char* __dirname);
    static inline char*
...
#    ifdef _INTL_REDIRECT_INLINE
    extern wchar_t* libintl_wbindtextdomain(
        const char* __domainname, const wchar_t* __wdirname);
...
#ifdef _INTL_REDIRECT_INLINE
    extern char* libintl_bind_textdomain_codeset(
        const char* __domainname, const char* __codeset);
    static inline char*
...
#    if !(                                                                     \
        (defined fprintf && defined _GL_STDIO_H) ||                            \
...
#    endif
#    if !(                                                                     \
        (defined vprintf && defined _GL_STDIO_H) ||                            \
...
#    endif
#    if !(                                                                     \
        (defined vsprintf && defined _GL_STDIO_H) ||                           \
...
#        endif
#        if !(                                                                 \
            (defined vsnprintf && defined _GL_STDIO_H) ||                      \
...
#define libintl_set_relocation_prefix libintl_set_relocation_prefix
    extern void libintl_set_relocation_prefix(
