...
/* _INTL_MAY_RETURN_STRING_ARG(n) declares that the given function may return
   ...
   printf (gettext ("foo %y")).  */
    ...
    !(defined __APPLE_CC__ && __APPLE_CC__ > 1 && defined __cplusplus)
...
#        if !(                                                                 \
            defined snprintf &&                                                \
            defined _GL_STDIO_H) /* don't override gnulib */
#            undef snprintf
