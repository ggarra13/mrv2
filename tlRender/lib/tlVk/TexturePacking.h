...
// ----------------------------------------------------------------------
// 1. Helper Function: Float to Specialized Component
// ----------------------------------------------------------------------
 ...
 */
inline
std::vector<uint32_t> packRGB_B10G11R11(const float* sourceDataRGB,
    ...
    for (size_t i = 0; i < byteSize; i += 3) {
        ...
        // Blue Component (B10)
        uint32_t packedB = floatToE5M(b, 5, 14); // 10 bits: 5 exp (16-31), 5 mant (0-15)
...
// ----------------------------------------------------------------------
// 2. Main Packing Function for half
// ----------------------------------------------------------------------
 ...
 */
inline
std::vector<uint32_t> packRGB_B10G11R11(const half* sourceDataRGB,
                                        const std::size_t byteSize) {
    if (byteSize % 3 != 0) {
        // Handle error: must have R, G, B for every pixel
        return {}; 
