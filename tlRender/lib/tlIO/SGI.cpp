...
namespace tl
{
    namespace sgi
    {
        ...
        void ReadPlugin::_init(const std::shared_ptr<log::System>& logSystem)
        {
            ...
            exts[".sgi"] = io::FileType::Sequence;
            exts[".rgb"] = io::FileType::Sequence;
            exts[".rgba"] = io::FileType::Sequence;
            exts[".bw"] = io::FileType::Sequence;
            IReadPlugin::_init("SGI", exts, logSystem);
        }
        ...
        void WritePlugin::_init(const std::shared_ptr<log::System>& logSystem)
        {
            ...
            exts[".rgba"] = io::FileType::Sequence;
            exts[".bw"] = io::FileType::Sequence;
            IWritePlugin::_init("SGI", exts, logSystem);
        }
