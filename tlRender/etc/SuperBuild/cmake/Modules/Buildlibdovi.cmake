...
set(libdovi_BUILD "")
if (WIN32)
    set(libdovi_INSTALL ${MRV2_MSYS_CMD} -c "([ -f /usr/bin/link.exe ] && mv -f /usr/bin/link /usr/bin/link_msys.exe) || true && cd dolby_vision && cargo cinstall --release --prefix ${INSTALL_PREFIX}")
else()
