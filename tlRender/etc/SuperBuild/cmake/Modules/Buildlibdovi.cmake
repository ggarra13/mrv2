...
if (NOT dovi_FOUND)
	...
	set(libdovi_INSTALL ${MRV2_MSYS_CMD} -c "([ -f /usr/bin/link.exe ] && mv -f /usr/bin/link /usr/bin/link_msys.exe) || true && cd dolby_vision && __COMPAT_LAYER=RunAsInvoker cargo cinstall --release --prefix ${INSTALL_PREFIX}" && ${libdovi_move_lib})
    else()
