...
if (NOT libssh2_FOUND)
    ...
    set(Libssh2_DEPENDENCIES ${OpenSSL_DEP} ${ZLIB_DEP})
    message(STATUS "Libssh2 DEPENDENCIES=${Libssh2_DEPENDENCIES}")

    ExternalProject_Add(
	Libssh2
	PREFIX ${CMAKE_CURRENT_BINARY_DIR}/../../../deps/Libssh2
	...
	PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different
        ...
        ${CMAKE_CURRENT_BINARY_DIR}/../../../deps/Libssh2/src/Libssh2/CMakeLists.txt
	LIST_SEPARATOR |
	CMAKE_ARGS ${Libssh2_ARGS})

    set(Libssh2_DEP Libssh2)
endif()
