...
if (NOT FFmpeg_FOUND)
    ...
    if(TLRENDER_LIBWEBP)
	list(APPEND FFmpeg_DEPENDENCIES ${LibWebP_DEP})
	list(APPEND FFmpeg_CONFIGURE_ARGS
	    --enable-libwebp
    ...
    if(TLRENDER_VPX)
	list(APPEND FFmpeg_DEPENDENCIES ${VPX_DEP})
	list(APPEND FFmpeg_CONFIGURE_ARGS
    ...
    if(TLRENDER_AOM)
	list(APPEND FFmpeg_DEPENDENCIES ${AOM_DEP})
	list(APPEND FFmpeg_CONFIGURE_ARGS
	    --enable-libaom
    ...
    if(TLRENDER_AV1)
	list(APPEND FFmpeg_DEPENDENCIES ${dav1d_DEP})
	list(APPEND FFmpeg_CONFIGURE_ARGS
	    --enable-libdav1d
    ...
    if(TLRENDER_SVTAV1)
	list(APPEND FFmpeg_DEPENDENCIES ${SvtAV1_DEP})
	list(APPEND FFmpeg_CONFIGURE_ARGS
	    --enable-libsvtav1
